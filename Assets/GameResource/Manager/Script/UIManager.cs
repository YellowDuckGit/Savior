...
{
    SignIn, SignUp, Recovery, Home, Loading, Play, Store, CollectionDecks, CollectionCards, CollectionSkins, CreateDeck, ChooseDeck
}
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] List<Button> switchSceneStore;
    ...
    void Start()
    {
        ...
        switchSceneStore.ForEach(a => a.onClick.AddListener(() => TurnOnStoreScene()));
        ...
        ACT_Register.onClick.AddListener(() => PlayfabManager.instance.Register(regEmail.text,regUsername.text,regPassword.text));
    ...
    {
        get { return loginMessage.text; }
        set { loginMessage.text = value; }
    }

    public string RegisterMessage
    {
        get { return regMessage.text; }
        set { regMessage.text = value; }
    }

    public string RecoverMessage
    {
        get { return recoverMessage.text; }
        set { recoverMessage.text = value; }
    }
    #endregion
}
