...
public class SpellCard : CardBase, ISpellCard
{
    ...
    public override Material Avatar { get { return _avartar; } set { this._avartar = value; this.PostEvent(EventID.OnCardUpdate, this); } }
    ...
    public override void LoadCardFromData()
    {
        ...
        //this.Avartar = _baseSpellData.Avartar;
